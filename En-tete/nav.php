...
session_start(); 
require_once(dirname(__DIR__).'/Fonction/auth.php');
forcer_connection();
require(dirname(__DIR__).'/Fonction/fonction.php');   
?>
    ...
    <script type="module" src="https://unpkg.com/ionicons@5.5.2/dist/ionicons/ionicons.esm.js"></script>
        ...
        <div class="parent">
            <div class="partie_choix_faculte">  
                    ...
                    <ion-icon name="home-outline"></ion-icon>
                        ...
                        <li><button type="button" class="button_menuType">
                            ...
                            <ul class="typedonnee_menu">
                                <li><a href="../Page/type_note_etudiant.php" title="Saisie des notes des étudiants">Note Etudiant</a></li>
                            </ul>
                        </li>
                        <li><a href="../Page/rapport.php" class="button_rapport">
                            <ion-icon name="analytics-outline"></ion-icon>
                            <span class="button_menu_titre">Rapport</span>
                            </a></li>
                        <li><a href="../Page/reglage.php" class="button_reglage">
                ...
                <div class="log_out">
                    <a type="button" class="button_log_out" href="../PageConnexionDeconnexion/deconnexion.php" style="text-decoration:none;">
